...
Learnt about the necessity of key prop in React and why it is required when
redering a list of elements or custom components. Also understood why it is
essential that a key prop should be unique and not an array index when the case
demands.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=asheer.vil%40gmail.com).
