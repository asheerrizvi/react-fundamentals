...
I learned about the document.body.append() method and wasn't aware that we can
append directly to the document body without querying it. Secondly, I used to
add classes to an element using classList.add and therefore wasn't aware of
assigning classes directly to className (which made it somewhat clear why React
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=asheer.vil%40gmail.com).
