...
Learnt about custom components and got a bit more clarity on how createElement
API works. Had a nice insight about why custom components should start with an
uppercase letter. Learnt about props validation and using PropTypes for the same
through our own PropTypes object and using the official npm package. Finally got
a glimpse of what React.Fragment is and when it is useful.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=asheer.vil%40gmail.com).
